...
fgc_betting is a customized DApp written in Python, which originally resembles the one provided by the sample [Echo Python DApp](https://github.com/cartesi/rollups-examples/tree/main/echo-python).
...
This will create a file at `./deployments/<network>/fgc_betting.address` with the deployed contract's address.
